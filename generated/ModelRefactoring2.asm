...
<asm version="1.0" name="0">
	<cp>
		<constant value="ModelRefactoring2"/>
		...
		<constant value="A.__matchFixNullable():V"/>
		<constant value="__exec__"/>
		<constant value="FixNullable"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyFixNullable(NTransientLink;):V"/>
		...
		<constant value="__matchFixNullable"/>
		...
		<constant value="__applyFixNullable"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="isNullable"/>
		...
		<constant value="12:24-12:38"/>
		<constant value="12:42-12:43"/>
		<constant value="12:42-12:56"/>
		<constant value="12:24-12:56"/>
		<constant value="12:73-12:74"/>
		<constant value="12:73-12:85"/>
		<constant value="12:62-12:67"/>
		<constant value="12:21-12:91"/>
		<constant value="12:7-12:91"/>
		<constant value="link"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	...
	<operation name="121">
		...
		<linenumbertable>
			...
			<lne id="132" begin="14" end="14"/>
			<lne id="133" begin="14" end="15"/>
			<lne id="134" begin="12" end="16"/>
			<lne id="135" begin="18" end="18"/>
			<lne id="136" begin="18" end="19"/>
			<lne id="137" begin="21" end="21"/>
			<lne id="138" begin="12" end="21"/>
			<lne id="139" begin="9" end="24"/>
			<lne id="120" begin="8" end="25"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="117" begin="7" end="25"/>
			<lve slot="2" name="83" begin="3" end="25"/>
			<lve slot="0" name="26" begin="0" end="25"/>
			<lve slot="1" name="140" begin="0" end="25"/>
		</localvariabletable>
	</operation>
</asm>
