...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchFixIntegerType():V"/>
		<constant value="__exec__"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyFixIntegerType(NTransientLink;):V"/>
		...
		<constant value="__matchFixIntegerType"/>
		<constant value="Column"/>
		<constant value="MM"/>
		<constant value="IN"/>
		<constant value="intiger"/>
		...
		<constant value="9:33-9:42"/>
		<constant value="9:24-9:42"/>
		<constant value="11:9-13:10"/>
		<constant value="__applyFixIntegerType"/>
		<constant value="NTransientLink;"/>
		<constant value="NTransientLink;.getSourceElement(S):J"/>
		<constant value="NTransientLink;.getTargetElement(S):J"/>
		<constant value="Integer"/>
		<constant value="MRefiningTrace!Element;.setProperty(SJB):V"/>
		<constant value="12:21-12:30"/>
		<constant value="12:13-12:30"/>
		<constant value="link"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	...
	<operation name="109">
		...
		<linenumbertable>
			...
			<lne id="123" begin="7" end="8"/>
			<lne id="124" begin="9" end="9"/>
			<lne id="125" begin="7" end="10"/>
			<lne id="126" begin="25" end="39"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="82" begin="6" end="41"/>
	...
	<operation name="127">
		...
		<linenumbertable>
			...
			<lne id="134" begin="9" end="15"/>
			<lne id="126" begin="8" end="16"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="119" begin="7" end="16"/>
			<lve slot="2" name="82" begin="3" end="16"/>
			<lve slot="0" name="26" begin="0" end="16"/>
			<lve slot="1" name="135" begin="0" end="16"/>
		</localvariabletable>
	</operation>
</asm>
